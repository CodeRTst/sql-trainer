...
public class SeedData
{
    ...
    public void CreateUsers() {
        modelBuilder.Entity<Teacher>().HasData(
            new Teacher { Id = 2, Pseudo = "ben", Password = "ben", FirstName = "Benoît", LastName = "Penelle", BirthDate = new DateTime(1970, 1, 2) },
            new Teacher { Id = 3, Pseudo = "bruno", Password = /*TokenHelper.GetPasswordHash("bruno")*/"bruno", FirstName = "Bruno", LastName = "Lacroix", BirthDate = new DateTime(1971, 2, 3) }
        );

        modelBuilder.Entity<Student>().HasData(
            new Student { Id = 4, Pseudo = "bob", Password = /*TokenHelper.GetPasswordHash("bob")*/"bob", FirstName = "Bob", LastName = "l'Eponge" },
            new Student { Id = 5, Pseudo = "caro", Password = /*TokenHelper.GetPasswordHash("caro")*/"caro", FirstName = "Caroline", LastName = "de Monaco" }
        );
    }
...
WHERE l.ID_P = p.ID_P
  ...
  AND s.CITY = 'London'" }
    ...
    //     modelBuilder.Entity<Attempt>().HasData(
    //         new Attempt { Id = 2, Start = new DateTimeOffset(new DateTime(2023, 10, 01)), Finish = new DateTimeOffset(new DateTime(2023, 10, 11)), QuizId = 1, StudentId = 4 }
    //     );
    //     modelBuilder.Entity<Answer>().HasData(
    //         new Answer { Id = 2, QuestionId = 1, AttemptId = 2, Sql = "SELECT * FROM S", IsCorrect = true }
    //     );
    // }


    // public void CreateAttempt3() {
    //     modelBuilder.Entity<Attempt>().HasData(
    //         new Attempt { Id = 3, Start = new DateTimeOffset(new DateTime(2023, 10, 01)), Finish = new DateTimeOffset(new DateTime(2023, 10, 11)), QuizId = 2, StudentId = 4 }
    //     );
    //     modelBuilder.Entity<Answer>().HasData(
    //         new Answer { Id = 3, QuestionId = 8, AttemptId = 3, Sql = "SELECT * FROM S", IsCorrect = true }
    //     );
    // }


    public void CreateAttempt4() {
        modelBuilder.Entity<Attempt>().HasData(
            new Attempt { Id = 4, Start = DateTimeOffset.Now, Finish = DateTimeOffset.Now, QuizId = 4, StudentId = 4 }
        );
        modelBuilder.Entity<Answer>().HasData(
            new Answer { Id = 4, QuestionId = 30, AttemptId = 4, Sql = "SELECT * FROM S", IsCorrect = true }
        );
        modelBuilder.Entity<Answer>().HasData(
            new Answer { Id = 5, QuestionId = 31, AttemptId = 4, Sql = "SELECT * FROM J", IsCorrect = false }
        );
    }
